...
col1.metric("🦠 Total Contagios", int(kpi_resumen.loc[kpi_resumen['indicador'] == 'Contagios', 'valor'].values[0]))
col2.metric("💚 Total Recuperados", int(kpi_resumen.loc[kpi_resumen['indicador'] == 'Recuperados', 'valor'].values[0]))
col3.metric("🖤 Total Fallecidos", int(kpi_resumen.loc[kpi_resumen['indicador'] == 'Fallecidos', 'valor'].values[0]))
col4.metric("⏱️ Promedio días recuperación", f"{kpi_resumen.loc[kpi_resumen['indicador'] == 'Promedio días recuperación', 'valor'].values[0]:.2f}")
